...
int main(){
  ...
  // fd avancar o numero de unidades
  // lf virar para esquerda o umero de graus
  // bk mover para trás
  // rt virar a direta o numero de graus
  ...
  while(t--){
    ...
    for(int i = 0 ; i < n ; ++i){
      ...
      if(str == "fd"){
        ...
        double dx = sin(DEG_to_RAD(theta))*uni;
        double dy = cos(DEG_to_RAD(theta))*uni;
