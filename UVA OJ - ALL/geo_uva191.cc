...
int main(){
  ...
  while(t--){
    ...
    if(IntersecaoDeSegmentos(A,B,C,D) || IntersecaoDeSegmentos(A,B,C,F)  || IntersecaoDeSegmentos(A,B,D,E)  || IntersecaoDeSegmentos(A,B,E,F) || (dentroDoPoligono(A,P) || dentroDoPoligono(B,P))){
      cout << "T\n";
    }else{
      cout << "F\n";
    }
